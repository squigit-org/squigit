...
export const Destination: React.FC<Props> = ({
  ...
  return (
    <StepLayout
      ...
      description="Setup will install Spatialshot into the following folder."
      icon={
        <img
    ...
    >
      <div className="flex flex-col space-y-6">
        ...
        <div className="flex space-x-2">
          ...
          <Button disabled className="!min-w-[70px] opacity-50 cursor-not-allowed">
            Browse...
          </Button>
        </div>

        <div className="flex items-center p-3 bg-white border border-gray-200 rounded-sm mt-auto">
          <HardDrive size={18} className="text-gray-500 mr-3" />
          <span className="text-sm text-gray-800">
            At least{" "}
            <span className="font-semibold">{REQUIRED_SPACE_MB} MB</span> of
