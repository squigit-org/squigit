  ...
  return (
    ...
    >
      <div className="flex flex-col space-y-6">
        ...
        <p className="text-sm text-gray-700">To continue, click Next.</p>
        ...
        <div className="flex space-x-2">
          ...
          <Button disabled className="!min-w-[70px]">
            Browse...
          </Button>
        </div>
        ...
        <div className="flex items-center p-3 bg-gray-100 border border-gray-200 rounded-sm">
          ...
          <span className="text-sm text-gray-800">
            At least{" "}
            <span className="font-semibold">{REQUIRED_SPACE_MB} MiB</span> of
