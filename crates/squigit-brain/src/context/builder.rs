...
use crate::context::loader::{
    interpolate, load_frame, load_scenes, load_soul, load_system, load_title_prompt,
};
...
pub fn build_system_instruction(user_name: &str, user_email: &str) -> Result<String, String> {
...
mod tests {
    ...
    fn test_build_initial_prompt() {
        ...
        assert!(prompt.contains("Squigit"));
