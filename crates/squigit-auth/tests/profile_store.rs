...
fn profile_id_from_identity() {
    ...
    assert_eq!(id1, id2);
    assert_eq!(id1.len(), "ggl-00000000-00000000-00000000-00000000".len());
...
fn profile_auth_tracks_active_profile() {
    let auth = ProfileAuth {
        ...
        active_profile_id: Some("ggl-00000000-00000000-00000000-00000000".to_string()),
        last_login: None::<LastLogin>,
    };

    assert_eq!(
        auth.active_profile_id.as_deref(),
        Some("ggl-00000000-00000000-00000000-00000000")
    );
}
