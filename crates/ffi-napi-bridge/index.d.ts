...
/* eslint-disable */
export declare function analyzeImage(imagePath: string, userMessage: string | undefined | null, onEvent: (err: null | Error, event: NapiStreamEvent) => void): Promise<NapiAnalyzeResult>
...
export declare function compressConversation(apiKey: string, imageBrief: string, historyToCompress: string): Promise<string>
...
export declare function generateImageBrief(apiKey: string, imagePath: string, model?: string | undefined | null): Promise<string>
...
export declare function promptChat(chatId: string, userMessage: string, onEvent: (err: null | Error, event: NapiStreamEvent) => void): Promise<NapiPromptResult>
