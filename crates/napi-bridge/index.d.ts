...
export declare function create_thread(title: string, imageHash: string, workspaceId?: string | undefined | null, displayName?: string | undefined | null): string
...
export declare function get_reverse_image_search_cache(threadId: string): string
...
export declare function overwrite_thread_messages(threadId: string, messagesJson: string): void
...
export declare function resolve_attachment_source_path(attachmentHash: string, threadId?: string | undefined | null): string | null
