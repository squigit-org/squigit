...
Welcome to SnapLLM! This guide will walk you through the essential features to get you started.

## First-Time Setup: Bring Your Own Key (BYOK)

SnapLLM uses a [**Bring Your Own Key (BYOK)**](../06-policies/BYOK.md) model. You provide your own API keys for Google Gemini and ImgBB, which means your data is sent directly to them, and you have full control over your usage and privacy.

1. Launch the SnapLLM application.
...
3. For both Google Gemini (for AI analysis) and ImgBB (for image uploading for the Lens feature), follow this secure process:
   ...
   - SnapLLM will automatically detect the key on your clipboard, save it securely, and confirm. You do **not** need to paste it anywhere.
...
5. The SnapLLM application will immediately open with your captured screenshot, and the AI will begin analyzing it based on your default prompt.

### Method 2: Use the Main Application Window

You can also use SnapLLM like a traditional application to analyze image files from your computer.

1. Open SnapLLM from your application menu or desktop shortcut.
...
- **Open in Lens:** Click the "Google Lens" icon in the chat interface. SnapLLM will upload your screenshot to ImgBB and open the image in Google Lens in your default browser for a powerful visual search.
