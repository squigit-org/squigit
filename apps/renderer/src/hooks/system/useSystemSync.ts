...
export const useSystemSync = () => {
  ...
  return {
    ...
    startupEffort: prefs.startupEffort,
    editingEffort: prefs.editingEffort,
    setEditingEffort: prefs.setEditingEffort,
    sessionEffort: prefs.sessionEffort,
    setSessionEffort: prefs.setSessionEffort,
