...
interface ThreadRouteLayoutProps {
...
const ThreadRouteLayoutComponent: React.FC<ThreadRouteLayoutProps> = ({
  headerRef,
  scrollContainerRef,
  bottomAnchorRef,
  inputContainerRef,
...
export const ThreadRouteLayout = React.memo(ThreadRouteLayoutComponent);
