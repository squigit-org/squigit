...
import { MessageList } from "@/features/thread";
import {
  type Message,
...
const ThreadRouteContentComponent: React.FC<ThreadRouteContentProps> = ({
  activeThreadId,
  parsedError,
  isErrorOpen,
  errorActions,
...
export const ThreadRouteContent = React.memo(
  ThreadRouteContentComponent,
  (prevProps, nextProps) => {
