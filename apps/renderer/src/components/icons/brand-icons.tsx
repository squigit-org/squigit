...
export const AppLogo = ({ size, color }: RequiredColorIconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 827 827"
...
<svg width={size} height={size} version="1.1" viewBox="0 0 268.1522 273.8827" overflow="hidden" xmlSpace="preserve" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="a">
