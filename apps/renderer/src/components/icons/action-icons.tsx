...
export const DragDotsIcon = ({ size, className, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CheckmarkIcon = ({ size, className, style, color }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CopyImageIcon = ({ size, className, style, color }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 17 17"
...
export const SaveFileIcon = ({ size, className, style, color }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 16 17"
